...
export const CartComponent: React.FC<CarProps> = ({ data }) => {
	return <div className='flex bg-white p-5 rounded-sm shadow-sm gap-10'>
		<div className='flex-1 divide-y'>
			{data.map(item => {
				return <div key={ item.group } className='flex py-4 items-center'>
		...
		<div className='w-72 bg-blue-50 py-6 px-5 h-max'>
