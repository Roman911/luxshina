...
export const Quantity: FC<QuantityProps> = ({ id = 0, price = 0, quantity, offerQuantity, onChange, setQuantity }) => {
	return <div className='quantity flex items-center'>
		...
		<div className='ml-6 text-4xl md:text-2xl font-bold'>{ +price * (quantity ?? 0) } ₴</div>
	</div>
};
